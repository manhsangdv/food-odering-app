...
var _require5 = require('./user.service'),
  UserService = _require5.UserService;
var _require6 = require('./schemas/user.schema'),
  UserSchema = _require6.UserSchema;
var UserModule = (_dec = Module({
  ...
  exports: [UserService]
}), _dec(_class = /*#__PURE__*/_createClass(function UserModule() {
